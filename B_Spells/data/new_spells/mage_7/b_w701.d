...
SAY @900020002
IF ~~ THEN REPLY @900020003 GOTO B_Rech100 //Tier One Wands
...
SAY @115123
IF ~HasItem("WANDFRE",Myself)~ THEN REPLY @115205 DO  ~TakePartyGold(2500) DestroyGold(2500)  TakePartyItemNum("SCRL1X",1) DestroyItem("SCRL1X") DestroyItem("WANDFRE") GiveItemCreate("B_WND12",Myself,10,1,1)~ EXIT
IF ~HasItem("B_WND12",Myself)~ THEN REPLY @115205 DO  ~TakePartyGold(2500) DestroyGold(2500)  TakePartyItemNum("SCRL1X",1) DestroyItem("SCRL1X") DestroyItem("B_WND12") GiveItemCreate("B_WND12",Myself,10,1,1)~ EXIT
IF ~HasItem("B_WND11",Myself)~ THEN REPLY @115205 DO  ~TakePartyGold(2500) DestroyGold(2500)  TakePartyItemNum("SCRL1X",1) DestroyItem("SCRL1X") DestroyItem("B_WND11") GiveItemCreate("B_WND11",Myself,10,1,1)~ EXIT
...
SAY @115122
IF ~HasItem("WANDFRE",Myself)~ THEN REPLY @115205 DO  ~TakePartyGold(2500) DestroyGold(2500)  RemoveSpell(WIZARD_ICE_STORM) DestroyItem("WANDFRE") GiveItemCreate("B_WND12",Myself,10,1,1)~ EXIT
IF ~HasItem("B_WND12",Myself)~ THEN REPLY @115205 DO  ~TakePartyGold(2500) DestroyGold(2500)  RemoveSpell(WIZARD_ICE_STORM) DestroyItem("B_WND12") GiveItemCreate("B_WND12",Myself,10,1,1)~ EXIT
IF ~HasItem("B_WND11",Myself)~ THEN REPLY @115205 DO  ~TakePartyGold(2500) DestroyGold(2500)  RemoveSpell(WIZARD_ICE_STORM) DestroyItem("B_WND11") GiveItemCreate("B_WND11",Myself,10,1,1)~ EXIT
IF ~~ THEN REPLY @115043 GOTO B_Rech401
IF ~~ THEN REPLY @115046 GOTO B_Rech001
IF ~~ THEN REPLY @115015 EXIT
END
...
IF ~~ THEN BEGIN B_Rech700
SAY @115041
IF ~Global("B_COR","GLOBAL",1)~ THEN REPLY @115216 GOTO B_Rech701 //Wand of Corr
IF ~Global("B_COR","GLOBAL",2)~ THEN REPLY @115217 EXIT  //Wand of cor Excluded: exit and try again.
IF ~~ THEN REPLY @115046 GOTO B_Rech001
IF ~~ THEN REPLY @115015 EXIT
END

IF ~~ THEN BEGIN B_Rech701     //Wand of Corr
SAY @115043
IF ~PartyHasItemIdentified("SCACID")~ THEN REPLY @115218 GOTO B_Rech701_01
IF ~HaveSpell(WIZARD_ACID_STORM)~ THEN REPLY @115219 GOTO B_Rech701_02
IF ~~ THEN REPLY @115046 GOTO B_Rech001
IF ~~ THEN REPLY @115015 EXIT
END

IF ~~ THEN BEGIN B_Rech701_01               //Scroll
SAY @115218
IF ~HasItem("WANDCOR",Myself)~ THEN REPLY @115220 DO  ~TakePartyGold(12500) DestroyGold(12500)  TakePartyItemNum("SCACID",1) DestroyItem("SCACID") DestroyItem("WANDCOR") GiveItemCreate("B_WND16",Myself,6,6,1)~ EXIT
IF ~HasItem("B_WND16",Myself)~ THEN REPLY @115220 DO  ~TakePartyGold(12500) DestroyGold(12500)  TakePartyItemNum("SCACID",1) DestroyItem("SCACID") DestroyItem("B_WND16") GiveItemCreate("B_WND16",Myself,6,6,1)~ EXIT
IF ~HasItem("B_WND17",Myself)~ THEN REPLY @115220 DO  ~TakePartyGold(12500) DestroyGold(12500)  TakePartyItemNum("SCACID",1) DestroyItem("SCACID") DestroyItem("B_WND17") GiveItemCreate("B_WND17",Myself,6,6,1)~ EXIT
IF ~~ THEN REPLY @115043 GOTO B_Rech701
IF ~~ THEN REPLY @115046 GOTO B_Rech001
IF ~~ THEN REPLY @115015 EXIT
END

IF ~~ THEN BEGIN B_Rech701_02               //Scroll
SAY @115219
IF ~HasItem("WANDCOR",Myself)~ THEN REPLY @115220 DO  ~TakePartyGold(12500) DestroyGold(12500)  RemoveSpell(WIZARD_ACID_STORM) DestroyItem("WANDCOR") GiveItemCreate("B_WND16",Myself,6,6,1)~ EXIT
IF ~HasItem("B_WND16",Myself)~ THEN REPLY @115220 DO  ~TakePartyGold(12500) DestroyGold(12500)  RemoveSpell(WIZARD_ACID_STORM) DestroyItem("B_WND16") GiveItemCreate("B_WND16",Myself,6,6,1)~ EXIT
IF ~HasItem("B_WND17",Myself)~ THEN REPLY @115220 DO  ~TakePartyGold(12500) DestroyGold(12500)  RemoveSpell(WIZARD_ACID_STORM) DestroyItem("B_WND17") GiveItemCreate("B_WND17",Myself,6,6,1)~ EXIT
IF ~~ THEN REPLY @115043 GOTO B_Rech701
IF ~~ THEN REPLY @115046 GOTO B_Rech001
IF ~~ THEN REPLY @115015 EXIT
END
